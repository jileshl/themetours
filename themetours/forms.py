...
class PassengerInfoForm(ModelForm):
      ...
      sector_from2 = forms.CharField(label="From", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      sector_to2 = forms.CharField(label="To", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      travel_date2 =  forms.DateField(label="Date", initial=datetime.date.today, widget=SelectDateWidget())

      sector_from3 = forms.CharField(label="From", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      sector_to3 = forms.CharField(label="To", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      travel_date3 =  forms.DateField(label="Date", initial=datetime.date.today, widget=SelectDateWidget())

      sector_from4 = forms.CharField(label="From", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      sector_to4 = forms.CharField(label="To", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      travel_date4 =  forms.DateField(label="Date", initial=datetime.date.today, widget=SelectDateWidget())

      sector_from5 = forms.CharField(label="From", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      sector_to5 = forms.CharField(label="To", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      travel_date5 =  forms.DateField(label="Date", initial=datetime.date.today, widget=SelectDateWidget())

      sector_from6 = forms.CharField(label="From", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      sector_to6 = forms.CharField(label="To", max_length=3, widget=forms.TextInput(attrs={"size":"4"}))
      travel_date6 =  forms.DateField(label="Date", initial=datetime.date.today, widget=SelectDateWidget())

      basic_fare = forms.DecimalField(label="Basic Fare",  max_digits=19, decimal_places=2)
      airline_taxes = forms.DecimalField(label="Airline Tax",  max_digits=19, decimal_places=2)
...
class SaleForm(ModelForm):
      ...
      additional_service_charge = forms.DecimalField(label="Additional Service Charges",  max_digits=19, decimal_places=2)
      discount = forms.DecimalField(label="Discount",  max_digits=19, decimal_places=2)
      round_off = forms.DecimalField(label="Round Off", max_digits=19, decimal_places=2)
